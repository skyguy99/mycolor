...
function getColorComboTextFormatted(colorItem)
{
  ...
  {
    return ([
      <View key = {0} pointerEvents='none' style = {{display: 'flex', backgroundColor: 'transparent', position: 'absolute', height: hp('100%'), width: wp('100.4%'), padding: 20, zIndex: 0, marginTop: -hp('75%'), overflow: 'hidden'}} >
          <Image style = {{width: wp('100%'), height: wp('100%'), position: 'absolute', marginTop: hp('60%')}} source={colorItem.image} />
      </View>,
